\documentclass[a4paper,12pt]{report}
    ...
    \sectionfont{\fontsize{16pt}{0}\selectfont}
    \subsectionfont{\normalfont \itshape \fontsize{16pt}{0}\selectfont}
    \subsubsectionfont{\normalfont \itshape \fontsize{16pt}{0}\selectfont}
    \paragraphfont{\fontsize{16pt}{0}\selectfont}
    \chapterfont{\fontsize{18pt}{0}\selectfont}
